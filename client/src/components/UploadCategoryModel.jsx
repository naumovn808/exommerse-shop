            ...
            <div className="bg-white max-w-4xl w-full p-4 rounded">
                <div className="flex flex-col gap-5">
                    ...
                    <form action="" className="flex flex-col gap-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center sm:justify-start lg:gap-4">
                                ...
                                >
                                    ...
                                    <div
                                        className={`absolute inset-0 flex items-center justify-center bg-black/40 rounded-md transition-opacity ${hover ? "opacity-100" : "opacity-0"
                                            }`}
                                    >
                                        {!data.image ? (
                        ...
                        {/* Submit Button */}
                        <button
                            className={`w-fit px-4 py-2 rounded-md mt-3 transition duration-200 ${data.name && data.image
                                    ? "bg-[#0C831F] hover:bg-[#2c4e33] text-white cursor-pointer"
                                    : "bg-gray-400 text-white cursor-not-allowed"
                                }`}
                            disabled={!data.name || !data.image.data}
                        >
                            Add Category
                        </button>
                    </form>
